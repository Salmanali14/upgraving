...
const Usernamepopup = ({ isOpen, handleClose }) => {
 ...
 var widthiner= window.innerWidth
  return (
    <Modal open={isDeleteDialogOpen} onClose={handleDeleteCancel}>
      ...
      <img src="images/User.png" style={{height:'60px',width:'60px'}} /></p>
        
        <Typography variant="body2" sx={{ fontFamily: 'Inter',margin:'10px',textAlign:'center' }}>
        {t("Username Changed Successfully!")}
        </Typography>
        <Box mt={2} display="flex" justifyContent="center">
          <Button onClick={handleDeleteCancel}  sx={{ fontFamily: 'Inter',color:'white',background: 'linear-gradient(to bottom, rgba(7, 183, 255, 1), rgba(79, 95, 255, 1))',borderRadius:'20px',width:'120px',height:'42px' }}>
            {t("Ok")}
          </Button>
        </Box>
      </Box>
