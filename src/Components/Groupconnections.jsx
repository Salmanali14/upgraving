...
export default function Groupconnections() {
  ...
  return (
    ...
    <div className='connection-btn44'>
     <Link to='/groupconnections'>
     <button id='peo-btn51'><CiGrid41 /> {'\u00A0'}Grid</button></Link>
     <Link to='/grouplist'>
     <button id='group-btn51'>{'\u00A0'}{'\u00A0'}<BsListCheck />{'\u00A0'}List</button>
     </Link>
     </div>
    </div>
    ...
    {connectionsData.map((connection, index) => (
      ...
      <div className='single-con-about'>
        <Link to='/singlegroup'>
          ...
          <Link to='/singlegroup'> <button id='more-con-btns-0'>Open</button></Link>
