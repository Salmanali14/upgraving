  ...
  return (
    <div className='Connections' style={{backgroundColor:color}}>
      ...
      <div className='search-con'>
        ...
        <input type='text' name='Search' placeholder={t("Search")} value={searchQuery} onChange={handleSearchInputChange}/>
      </div>
      <div className='connection-btn'>
        <Link to='/connections'>
          <button id='peo-btn'>{t("People")}</button>
        </Link>
      ...
      <div className='grid'>
        <div className='connection-btn44'>
          <Link to='/connections'>
            <button id='peo-btn51'><CiGrid41 /> {'\u00A0'}{t("Grid")}</button>
          </Link>
          <Link to='/list'>
      ...
      <Defaultallprofile searchQuery={searchQuery} /> 
      <br></br>
      <br></br>
      <br></br>
      <br></br>
