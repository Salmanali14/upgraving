...
export default function Defaultallprofile() {
    ...
    {connectionsData.map((connection, index) => (
      <div key={index} className='single-con'>
        ...
        <div className='single-con-about'>
          <h1 id='icon-heds-1'>{connection.date}</h1>
          <h2 id='icon-heds-2'>{connection.name} </h2>
          <h3 id='icon-heds-3'>{connection.role}</h3>
          <div className='single-con-btn'>
            <button id='more-con-btns-0' onClick={handleOpenModal}>Open</button>
            <div className='more-btn' id='more-con-btns-1' onClick={handleDeleteButtonClick} >
